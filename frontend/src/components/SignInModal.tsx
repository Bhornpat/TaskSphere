...
export default function SignInModal({ onClose }: { onClose: () => void }) {
	...
	return (
		<div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
			<div className="bg-white dark:bg-[#1e1e1e] p-6 rounded-lg shadow-lg w-full max-w-md relative">
				<button
					onClick={onClose}
				...
				<p className="text-center text-sm text-gray-500 font-mono dark:text-gray-300 mb-4">
					Your journey starts here
				</p>

				<p className="text-center text-sm font-mono text-gray-500 dark:text-gray-400 mb-4">
					Still outside? <a className="text-orange-600 font-mono hover:underline" href="/register">Register</a> and jump in
				</p>
				...
				<form onSubmit={handleSubmit} className="space-y-5 text-left">
					...
					<button
						type="submit"
						className="w-full bg-gradient-to-r from-pink-600 via-red-500 to-yellow-400 shadow-md  text-white py-2 rounded-full hover:brightness-110 transition duration-300 font-bold"
					>
						Sign In
					</button>
				</form>
